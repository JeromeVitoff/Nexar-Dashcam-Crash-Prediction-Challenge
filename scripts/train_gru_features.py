"""
Entraînement GRU sur Features Pré-extraites
============================================

Entraîne le GRU directement sur les features EfficientNet-B0 pré-extraites.
10× plus rapide que l'entraînement complet EfficientNet-GRU.

Usage:
    python scripts/train_gru_features.py --features_dir features/efficientnet_b0
...
def main():
    parser = argparse.ArgumentParser(description="Train GRU on pre-extracted features")
    
    # Data
    parser.add_argument('--train_csv', type=str, default='Data/train.csv')
    parser.add_argument('--features_dir', type=str, default='features/efficientnet_b0')
    ...
    parser.add_argument('--save_dir', type=str, default='checkpoints/gru_features')
    
    args = parser.parse_args()
    
    print("\n" + "="*70)
    print("🚀 ENTRAÎNEMENT GRU (Features Pré-extraites EfficientNet)")
    print("="*70)
    ...
    from src.models.gru_features import GRUFeatureClassifier
    ...
    model = GRUFeatureClassifier(
        input_dim=1280,  # EfficientNet-B0 output
